...
export const add = (transactions: AccountTransaction[], account: Account, page?: number) => ({
 ...
 */
export const reset = (account: Account) => ({
 ...
 * @param {Account} account
 */
export const remove = (account: Account, txs: WalletAccountTransaction[]) => ({
